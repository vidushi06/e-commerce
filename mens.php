...
<body>
	...
	<Section><!--buttons-->
		<div class="container-fluid">
			<center><h2>MENS SECTION</h2></center>
			...
			<button type="button" class="btn btn-outline-warning bg-white" style="margin-top: 20px"><a href="#y" class="text-decoration-none text-warning">bottom wears</a></button>

			<button type="button" class="btn btn-outline-warning bg-white" style="margin-top: 20px"><a href="#z" class="text-decoration-none text-warning">accesories</a></button>
	
		</div><!--end of container-->
	</Section><!--end buttons-->
	<br>
	<section id="x"><!--upperwear--->
		<div class="container-fluid">
			<div class="row">
				<center><h3>Top Wears</h3></center>
			</div><br><!---end of row-->
			<div class="row">
				<div class="col-md-2">
					<div class="card">
	...
	</section><!--end of upperwear-->
	<br>
	<section id="y"><!--start of lowers--->
		<div class="container-fluid">
			<div class="row">
				<center><h3>Bottom Wears</h3></center>
			</div><br><!---end of row-->
			<div class="row">
				<div class="col-md-2">
					<div class="card">
	...
	</section><!--end of lowers-->
	<br>
	<section id="z"><!--start of lowers--->
		<div class="container-fluid">
			<div class="row">
				<center><h3>Accesories</h3></center>
			</div><br><!---end of row-->
			<div class="row">
				<div class="col-md-2">
					<div class="card">
